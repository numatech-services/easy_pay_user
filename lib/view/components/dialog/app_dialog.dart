                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: ConstrainedBox(
                      constraints:
                          BoxConstraints(minHeight: constraint.maxHeight / 2),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Directionality(
                                ...
                                child: SwipeAnimatedButton(
                                    onFinish: onfinish, onWaiting: onwaiting))
                          ],
                        ),
                      ),
                    ),
                                  ...
                                  decoration: const BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        ...
                                        blurRadius: 12,
                                        color:
                                            Color.fromRGBO(29, 111, 251, 0.20),
                                      ),
                                    ],
        ...
        return Dialog(
          ...
          child: LayoutBuilder(builder: (context, constraint) {
            return SingleChildScrollView(
              child: ConstrainedBox(
                constraints:
                    BoxConstraints(minHeight: constraint.maxHeight / 3),
                child: Container(
