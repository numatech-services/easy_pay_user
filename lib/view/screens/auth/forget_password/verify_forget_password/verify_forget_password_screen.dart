...
import 'package:viserpay/data/controller/auth/forget_password/verify_password_controller.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: DefaultText(
                                  text: '${MyStrings.verifyPasswordMobileSubText.tr} : ${MyUtils().maskSensitiveInformation(controller.email)}',
