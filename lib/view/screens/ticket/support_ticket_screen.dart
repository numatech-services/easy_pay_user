...
import 'package:viserpay/data/controller/support/support_controller.dart';
...
import 'package:viserpay/view/components/floating_action_button/fab.dart';
import 'package:viserpay/view/components/shimmer/ticket_card_shimmer.dart';
    ...
    return GetBuilder<SupportController>(builder: (controller) {
      return Scaffold(
        ...
        floatingActionButton: FAB(
          callback: () {
            Get.toNamed(RouteHelper.addNewTicketScreen)?.then((value) => {Get.find<SupportController>().getSupportTicket()});
          },
        ),
      );
    });
