...
class _AddMoneyHistoryScreenState extends State<AddMoneyHistoryScreen> {
  ...
  void initState() {
    ...
    final controller =
        Get.put(AddMoneyHistoryController(addMoneyHistoryRepo: Get.find()));
    super.initState();
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.dark
          .copyWith(statusBarColor: MyColor.colorWhite),
                      ...
                      children: [
                        ...
                        controller.depositList.isEmpty &&
                            ...
                            ? Center(
                                child: NoDataWidget(
                                    noDataText:
                                        MyStrings.emptyAddMoneyTitle.tr),
                              )
