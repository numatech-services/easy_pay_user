        ...
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(
                child: CardColumn(
                  header: "${controller.depositList[index].paymentType}",
                  body:
                      "Nombre de tickets: ${controller.depositList[index].ticketCount ?? ""} ${controller.currency}",
                ),
              ),
              Expanded(
                child: CardColumn(
                    alignmentEnd: true,
                    header: "Portail de paiement",
                    body:
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          "(CFA${StringConverter.formatNumber(controller.depositList[index].amount ?? "")} x ${controller.depositList[index].ticketCount ?? ""} "
                    ...
                    Text(
                      "${StringConverter.formatNumber("${double.parse(controller.depositList[index].amount!) * int.parse(controller.depositList[index].ticketCount!)}")} CFA",
              ...
              : Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                        ...
                        itemCount:
                            controller.depositList[index].detail?.length ?? 0,
                        separatorBuilder: (context, detailIndex) =>
                            const SizedBox(height: Dimensions.space10),
                        itemBuilder: (context, detailIndex) {
                          if (controller.depositList[index].detail?[detailIndex]
                                  .type ==
                              'file') {
