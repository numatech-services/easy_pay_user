...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(countries: json["countries"] == null ? [] : List<Country>.from(json["countries"]!.map((x) => Country.fromJson(x))), user: json['user'] == null ? null : GlobalUser.fromJson(json['user']));
}
