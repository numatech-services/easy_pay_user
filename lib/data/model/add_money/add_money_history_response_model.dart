...
class DepositsData {
  ...
  DepositsData.fromJson(dynamic json) {
    ...
    _ticketType =
        json['ticket_type'] != null ? json['ticket_type'].toString() : "";
    _ticketAmount =
        json['ticket_amount'] != null ? json['ticket_amount'].toString() : "0";
    _ticketCount =
        json['ticket_count'] != null ? json['ticket_count'].toString() : "0";
    if (json['detail'] != null) {
      _detail = [];
      try {
  ...
  String? get ticketAmount => _ticketAmount;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['ticket_amount'] = _ticketAmount;
