...
import 'package:viserpay/view/screens/ticket/my_tickets_screen.dart';
...
class HomeController extends GetxController {
  ...
  List<Widget> getModuleList() {
    ...
    temModuleList.add(
      CircleAnimatedButtonWithText(
        ...
        child: const Icon(Icons.confirmation_number_outlined,
            color: Color(0xFF08CAD1), size: 26),
        onTap: () {
          Navigator.push(
            Get.context!,
            MaterialPageRoute(builder: (_) => const UserTicketScreen()),
          );
        },
      ),
    );
    ...
    temModuleList.add(
      CircleAnimatedButtonWithText(
        buttonName: "Historique des dépôts",
        backgroundColor: MyColor.addMoneyBaseColor.withOpacity(0.1),
